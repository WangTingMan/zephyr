...
#ifndef CONFIG_SETTINGS_FILE_PATH
#define CONFIG_SETTINGS_FILE_PATH BUILD_PATH "settings.ini"
#endif

#ifndef CONFIG_SETTINGS_FILE_MAX_LINES
#define CONFIG_SETTINGS_FILE_MAX_LINES 100
#endif
